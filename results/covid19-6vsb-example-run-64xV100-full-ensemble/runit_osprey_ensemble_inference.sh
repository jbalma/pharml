...
#list_of_files="bindingdb_2019m4_5of25pct_b 
...
do
    ...
    ENSEMBLE_MODELS=/lus/scratch/jbalma/pharml_results_5layer/ensemble_models
    ENSEMBLE_OUTPUT=/lus/scratch/jbalma/pharml_results_5layer/ensemble_outputs
...
#-rw-r--r--. 1 avose criemp 149M Jun 23 07:06 /lus/scratch/avose/data/map/bindingdb_2019m4_75.map
    ...
    #echo "Running Train..."
    #date
    #srun -c ${NC} --hint=multithread -l -N ${NODES} -n ${NP} --ntasks-per-node=${PPN} --ntasks-per-socket=${PPS} -u --exclusive --cpu_bind=rank_ldom --accel-bind=g,v python mldock_gnn.py \
    ...
    #echo "saving model to ${ENSEMBLE_MODELS}/model_${model_n}/checkpoints..."
